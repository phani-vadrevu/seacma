...
SERVER_ADDRESS = "http://ec2-34-219-9-37.us-west-2.compute.amazonaws.com:14284"
def get_job():
    job_fetch_url = SERVER_ADDRESS + '/s3hunt3r_milk_1/fetch_job'
...
def post_job(stats,):
    job_post_url = SERVER_ADDRESS + '/s3hunt3r_milk_1/post'
