...
void DownloadManagerImpl::StartDownloadWithId(
  ...
  log_str << "LOG::Forensics::DownloadManagerImpl::" << __func__ << " :"
          << "\n  guid=" << info->guid
          << "\n  start_time=" << info->start_time
          << "\n  remote_address=" << info->remote_address
          << "\n  mime_type=" << info->mime_type
          << "\n  original_mime_type=" << info->original_mime_type
          << "\n  http_req_method=" << info->method;
  for(auto url : info->url_chain) {
    log_str << "\n  url=" << url.possibly_invalid_spec();
  }
  log_str << "\n  referrer_url=" << info->referrer_url.possibly_invalid_spec()
          << "\n  site_url=" << info->site_url.possibly_invalid_spec()
          << "\n  tab_url=" << info->tab_url.possibly_invalid_spec()
          << "\n  tab_referrer_url=" << info->tab_referrer_url.possibly_invalid_spec()
          << "\n  total_bytes=" << info->total_bytes
          << "\n  has_user_gesture=" << info->has_user_gesture
          << "\n  transient=" << info->transient
          << "\n  file_path=" << download_file->FullPath().value()
          << "\n---";
